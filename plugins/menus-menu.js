...
const handler = async (m, {conn, usedPrefix, usedPrefix: _p, __dirname, text, isPrems}) => {
  ...
  try {
    ...
    const str = ` 𝐌𝐈𝐊𝐎𝐓𝐎-𝐔𝐑𝐀𝐁𝐄

 👋 *Hola,* ${taguser}

『▢ *Editor: kleber orozco
『▢ *WA:* +593979333577
➤➤➤INSTAGRAM: https://instagram.com/kinome.op?igshid=OGQ5ZDc2ODk2ZA==
➤➤➤CANAL DE YOUTUBE:https://youtube.com/@Urabe-Mikoto-MD?si=utz9pOhP0RaCXzVr
★ ☆ ✰ ✯ ✡ ✪ ✶ ✱ ✲ ✴ ✼ ✻ ✵ ❇ ❈ ❊ ❖ ❄ ❆ ❋ ❂ ⁂
『▢ *Fecha:* ${date}
『▢ *Uptime:* ${uptime}
...
▢ _${usedPrefix}disable autoread_▢ _${usedPrefix}enable antispam_
